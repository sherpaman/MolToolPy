...
#
parser.add_argument("--x_ref",dest="interleave",action="store_true",default=False,help="toggle interleaving of reference data")
parser.add_argument("--x_dat",dest="interleave",action="store_true",default=False,help="toggle interleaving of target data")
